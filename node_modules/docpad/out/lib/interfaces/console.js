        ...
        return consoleInterface.confirm(locale.subscribePrompt, {
          ...
          return docpad.track('subscribe', {
            ...
            return safeps.spawnCommands('git', commands, function(err, results) {
              ...
              userConfig.name = String((results != null ? (ref = results[0]) != null ? ref[1] : void 0 : void 0) || '').trim() || null;
              userConfig.email = String((results != null ? (ref1 = results[1]) != null ? ref1[1] : void 0 : void 0) || '').trim() || null;
              userConfig.username = String((results != null ? (ref2 = results[2]) != null ? ref2[1] : void 0 : void 0) || '').trim() || null;
