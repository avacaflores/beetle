...
(function() {
  var Backbone, FileModel, Model, TaskGroup, docpadUtil, encodingUtil, extendr, extractOptsAndCallback, isTextOrBinary, jschardet, mime, pathUtil, ref, safefs, typeChecker, util,
  ...
  ref = require('../base'), Backbone = ref.Backbone, Model = ref.Model;
  ...
  FileModel = (function(superClass) {
    ...
    FileModel.prototype.getMeta = function() {
      ...
      if (args.length) {
        return (ref1 = this.meta).get.apply(ref1, args);
      } else {
        return this.meta;
      }
    };
    ...
    FileModel.prototype.set = function(attrs, opts) {
      var newAttrs, options, ref1;
      if (typeChecker.isString(attrs)) {
        newAttrs = {};
        newAttrs[attrs] = opts;
        return this.set(newAttrs, opts);
      }
      attrs = (ref1 = typeof attrs.toJSON === "function" ? attrs.toJSON() : void 0) != null ? ref1 : attrs;
    ...
    FileModel.prototype.load = function(opts, next) {
      var file, filePath, fullPath, ref1, tasks;
      if (opts == null) {
        opts = {};
      }
    ...
    FileModel.prototype.parse = function(opts, next) {
      var buffer, changes, content, encoding, isText, ref1, ref2, relativePath, source;
      if (opts == null) {
        opts = {};
      }
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      ...
      if (buffer && (encoding != null) === false || opts.reencode === true) {
        ...
        if (isText === true) {
          if (this.detectEncoding) {
            ...
            if (encoding == null) {
              encoding = (ref2 = jschardet.detect(buffer)) != null ? ref2.encoding : void 0;
            }
          }
    ...
    FileModel.prototype.write = function(opts, next) {
      ...
      if ((ref2 = opts.encoding.toLowerCase()) !== 'ascii' && ref2 !== 'utf8' && ref2 !== 'utf-8' && ref2 !== 'binary') {
