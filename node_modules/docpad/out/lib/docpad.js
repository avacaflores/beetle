...
(function() {
  ...
  ref = require('./base'), queryEngine = ref.queryEngine, Backbone = ref.Backbone, Events = ref.Events, Model = ref.Model, Collection = ref.Collection, View = ref.View, QueryCollection = ref.QueryCollection;
  ...
  DocPad = (function(superClass) {
    ...
    DocPad.Backbone = Backbone;

    DocPad.queryEngine = queryEngine;
    ...
    DocPad.prototype.getLogger = function() {
      var ref1;
      return (ref1 = this.loggerInstances) != null ? ref1.logger : void 0;
    };
    ...
    DocPad.prototype.getCollection = function(value) {
      var collection, i, j, len, len1, ref1, ref2;
      if (value) {
    ...
    DocPad.prototype.eachCollection = function(fn) {
      var collection, i, index, len, ref1;
      fn(this.getDatabase(), 'database');
      ref1 = this.collections;
      for (index = i = 0, len = ref1.length; i < len; index = ++i) {
        collection = ref1[index];
    ...
    DocPad.prototype.getPort = function() {
      ...
      return (ref1 = (ref2 = (ref3 = (ref4 = this.getConfig().port) != null ? ref4 : process.env.PORT) != null ? ref3 : process.env.VCAP_APP_PORT) != null ? ref2 : process.env.VMC_APP_PORT) != null ? ref1 : 9778;
    };

    DocPad.prototype.getHostname = function() {
      var ref1, ref2;
      return (ref1 = (ref2 = this.getConfig().hostname) != null ? ref2 : process.env.HOSTNAME) != null ? ref1 : null;
    };

    function DocPad(instanceConfig, next) {
      var action, configEventContext, docpad, i, len, logger, loggerConsole, loggers, methodName, ref1, ref2, ref3;
      ref1 = extractOptsAndCallback(instanceConfig, next), instanceConfig = ref1[0], next = ref1[1];
      docpad = this;
      ...
      this.getEvents().forEach(function(eventName) {
        return docpad.on(eventName, function(opts, next) {
          var args, eventHandler, ref3;
          eventHandler = (ref3 = docpad.getConfig().events) != null ? ref3[eventName] : void 0;
      ...
      this.setLogLevel((ref3 = instanceConfig.logLevel) != null ? ref3 : this.initialConfig.logLevel);
      ...
      this.database = new FilesCollection(null, {
        ...
        var j, len1, outPath, ref4, updatedModels, url;
        ...
        var j, k, len1, len2, ref4, ref5, url;
        if (model.get('write') === false) {
          return;
        }
        ref4 = model.previous('urls') || [];
        for (j = 0, len1 = ref4.length; j < len1; j++) {
          url = ref4[j];
          delete docpad.filesByUrl[url];
        }
    ...
    DocPad.prototype.ready = function(opts, next) {
      var config, docpad, instanceConfig, locale, pluginName, pluginsList, ref1, tasks;
      ref1 = extractOptsAndCallback(instanceConfig, next), instanceConfig = ref1[0], next = ref1[1];
      docpad = this;
      config = this.getConfig();
      locale = this.getLocale();
      ...
      if (this.getDebugging()) {
        pluginsList = ((function() {
          ...
          ref2 = Object.keys(this.loadedPlugins).sort();
          results = [];
          for (i = 0, len = ref2.length; i < len; i++) {
            pluginName = ref2[i];
    ...
    DocPad.prototype.mergeConfigurations = function(configPackages, configsToMerge) {
      var configPackage, env, envConfig, envs, i, j, len, len1, ref1;
    ...
    DocPad.prototype.setConfig = function(instanceConfig, next) {
      var configPackages, configsToMerge, docpad, i, j, k, key, l, len, len1, len2, len3, locale, postTasks, ref1, ref2, ref3, type, typePath, typePaths;
      ref1 = extractOptsAndCallback(instanceConfig, next), instanceConfig = ref1[0], next = ref1[1];
      docpad = this;
      locale = this.getLocale();
      if (instanceConfig) {
    ...
    DocPad.prototype.load = function(instanceConfig, next) {
      var docpad, locale, preTasks, ref1;
      ref1 = extractOptsAndCallback(instanceConfig, next), instanceConfig = ref1[0], next = ref1[1];
      docpad = this;
      locale = this.getLocale();
    ...
    DocPad.prototype.updateUserConfig = function(data, next) {
      var docpad, ref1, userConfigPath;
      if (data == null) {
        data = {};
      }
      ref1 = extractOptsAndCallback(data, next), data = ref1[0], next = ref1[1];
      docpad = this;
    ...
    DocPad.prototype.loadConfigPath = function(opts, next) {
      ...
      load = function(configPath) {
        ...
        return safefs.exists(configPath, function(exists) {
          ...
          return CSON.requireFile(configPath, csonOptions, function(err, result) {
            if (err) {
    ...
    DocPad.prototype.getConfigPath = function(opts, next) {
      var config, docpad, ref1, result, tasks;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = this.getConfig();
      result = null;
    ...
    DocPad.prototype.resetCollections = function(opts, next) {
      var database, docpad, meta, ref1, scripts, styles;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
    ...
    DocPad.prototype.installNodeModule = function(names, opts) {
      var command, config, docpad, next, ref1;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = this.getConfig();
      if (opts.cwd == null) {
    ...
    DocPad.prototype.createError = function(err, opts) {
      var key, ref1, ref2, ref3, ref4, ref5, ref6, ref7, value;
      if (opts == null) {
        opts = {};
      }
      if (opts.level == null) {
        opts.level = (ref1 = err.level) != null ? ref1 : 'error';
      }
      if (opts.track == null) {
        opts.track = (ref2 = err.track) != null ? ref2 : true;
      }
      if (opts.tracked == null) {
        opts.tracked = (ref3 = err.tracked) != null ? ref3 : false;
      }
      if (opts.log == null) {
        opts.log = (ref4 = err.log) != null ? ref4 : true;
      }
      if (opts.logged == null) {
        opts.logged = (ref5 = err.logged) != null ? ref5 : false;
      }
      if (opts.notify == null) {
        opts.notify = (ref6 = err.notify) != null ? ref6 : true;
      }
      if (opts.notified == null) {
        opts.notified = (ref7 = err.notified) != null ? ref7 : false;
      }
      if (err.context != null) {
    ...
    DocPad.prototype.logError = function(err) {
      var docpad, locale, message, occured, ref1;
      docpad = this;
      locale = this.getLocale();
      if (err && err.log !== false && err.logged !== true) {
        ...
        occured = (ref1 = err.level) === 'warn' || ref1 === 'warning' ? locale.warnOccured : locale.errorOccured;
    ...
    DocPad.prototype.notifyError = function(err) {
      var docpad, locale, occured, ref1;
      docpad = this;
      locale = this.getLocale();
    ...
    DocPad.prototype.checkRequest = function(next) {
      ...
      return function(err, res) {
        ...
        if (((ref1 = res.body) != null ? ref1.success : void 0) === false || ((ref2 = res.body) != null ? ref2.error : void 0)) {
    ...
    DocPad.prototype.subscribe = function(next) {
      var config, data, err, ref1;
      config = this.getConfig();
      if (config.offline === false) {
        if ((ref1 = this.userConfig) != null ? ref1.email : void 0) {
          data = {};
    ...
    DocPad.prototype.track = function(name, things, next) {
      var config, data, docpad, ref1, trackRunner;
      if (things == null) {
        things = {};
      }
      docpad = this;
      ...
      if (config.offline === false && config.reportStatistics) {
        ...
        if ((ref1 = this.websitePackageConfig) != null ? ref1.name : void 0) {
    ...
    DocPad.prototype.identify = function(next) {
      var config, data, docpad, now, ref1, things;
      docpad = this;
      config = this.getConfig();
      if (config.offline === false && config.reportStatistics && ((ref1 = this.userConfig) != null ? ref1.username : void 0)) {
        data = {};
    ...
    DocPad.prototype.attachModelEvents = function(model) {
      ...
      if (model.attachedDocumentEvents !== true) {
        ...
        model.on('log', function() {
          ...
          args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
          if (args.length === 2) {
            if ((ref1 = args[0]) === 'err' || ref1 === 'error') {
              docpad.error(args[1]);
              return;
            }
            if ((ref2 = args[0]) === 'warn' || ref2 === 'warning') {
              docpad.warn(args[1]);
              return;
            }
          }
    ...
    DocPad.prototype.createModel = function(attrs, opts) {
      var config, database, dirPath, docpad, fileFullPath, i, j, len, len1, model, ref1, ref2, result;
      if (attrs == null) {
        attrs = {};
      }
      if (opts == null) {
      ...
      if (fileFullPath) {
        if (!opts.modelType) {
          ref1 = config.documentsPaths.concat(config.layoutsPaths);
          for (i = 0, len = ref1.length; i < len; i++) {
            dirPath = ref1[i];
    ...
    DocPad.prototype.parseDirectory = function(opts, next) {
      var createFunction, docpad, files, locale, path, ref1;
      if (opts == null) {
        opts = {};
      }
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
    ...
    DocPad.prototype.destroyPlugins = function() {
      var name, plugin, ref1;
      ref1 = this.loadedPlugins;
      for (name in ref1) {
        if (!hasProp.call(ref1, name)) continue;
        plugin = ref1[name];
        plugin.destroy();
    ...
    DocPad.prototype.contextualizeFiles = function(opts, next) {
      var collection, config, docpad, locale, ref1, ref2, slowFilesObject, slowFilesTimer, templateData;
      if (opts == null) {
        opts = {};
      }
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      ...
      slowFilesObject = {};
      slowFilesTimer = null;
      if ((ref2 = opts.progress) != null) {
        ref2.step("contextualizeFiles (preparing)").total(1).setTick(0);
      }
      ...
      docpad.emitSerial('contextualizeBefore', {
        ...
        tasks = new docpad.TaskGroup("contextualizeFiles tasks", {
          ...
          next: function(err) {
            ...
            if ((ref3 = opts.progress) != null) {
              ref3.step("contextualizeFiles (postparing)").total(1).setTick(0);
            }
        ...
        if ((ref3 = opts.progress) != null) {
          ref3.step('contextualizeFiles').total(collection.length).setTick(0);
        }
    ...
    DocPad.prototype.renderFiles = function(opts, next) {
      var collection, config, docpad, locale, ref1, ref2, renderCollection, renderFile, renderPasses, slowFilesObject, slowFilesTimer, templateData;
      if (opts == null) {
        opts = {};
      }
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      ...
      slowFilesTimer = null;
      if ((ref2 = opts.progress) != null) {
        ref2.step("renderFiles (preparing)").total(1).setTick(0);
      }
      ...
      renderCollection = function(collectionToRender, arg, next) {
        ...
        return docpad.emitSerial('renderCollectionBefore', {
          ...
          if ((ref3 = opts.progress) != null) {
            ref3.step("renderFiles (pass " + renderPass + ")").total(collectionToRender.length).setTick(0);
          }
      ...
      docpad.emitSerial('renderBefore', {
        ...
        tasks = new docpad.TaskGroup("renderCollection: renderBefore tasks", {
          next: function(err) {
            ...
            if ((ref3 = opts.progress) != null) {
              ref3.step("renderFiles (postparing)").total(1).setTick(0);
            }
    ...
    DocPad.prototype.writeFiles = function(opts, next) {
      ...
      slowFilesTimer = null;
      if ((ref2 = opts.progress) != null) {
        ref2.step("writeFiles (preparing)").total(1).setTick(0);
      }
      ...
      docpad.emitSerial('writeBefore', {
        ...
        tasks = new docpad.TaskGroup("writeFiles tasks", {
          ...
          next: function(err) {
            ...
            if ((ref3 = opts.progress) != null) {
              ref3.step("writeFiles (postparing)").total(1).setTick(0);
            }
        ...
        if ((ref3 = opts.progress) != null) {
          ref3.step('writeFiles').total(collection.length).setTick(0);
        }
        collection.forEach(function(file, index) {
          var filePath;
          filePath = file.getFilePath();
    ...
    DocPad.prototype.generate = function(opts, next) {
      var addGroup, addTask, config, database, docpad, lastGenerateStarted, locale, ref1, ref2, tasks;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = docpad.getConfig();
      locale = docpad.getLocale();
      database = docpad.getDatabase();
      if (((ref2 = opts.collection) != null ? ref2.length : void 0) === 0) {
        return next();
      }
      ...
      tasks = new this.TaskGroup("generate tasks", {
        ...
        howMany = (((ref3 = opts.collection) != null ? ref3.length : void 0) || 0) + "/" + database.length;
      ...
      addGroup('fetch data to render', function(addGroup, addTask) {
        ...
        if (opts.populate === true) {
          ...
          if (opts.initial === true && ((ref3 = opts.cache) === true || ref3 === 'read')) {
          ...
          return collection.forEach(function(file) {
            ...
            if (file.get('isLayout') === true) {
              ...
              docpad.log('debug', 'Layout children to generate at', lastGenerateStarted, '\n', (function() {
                var i, len, ref3, results;
                ref3 = layoutChildrenCollection.models;
                results = [];
                for (i = 0, len = ref3.length; i < len; i++) {
                  model = ref3[i];
                  results.push({
      ...
      addTask('Write the database cache', function(complete) {
        var databaseData, databaseDataDump, model, ref3;
        if ((ref3 = opts.cache) !== true && ref3 !== 'write') {
          return complete();
        }
        databaseData = {
    ...
    DocPad.prototype.renderText = function(text, opts, next) {
      var attributes, clone, document, ref1;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
    ...
    DocPad.prototype.destroyWatchers = function() {
      var docpad, i, len, ref1, watcher;
      docpad = this;
      if (docpad.watchers) {
        ref1 = docpad.watchers;
        for (i = 0, len = ref1.length; i < len; i++) {
          watcher = ref1[i];
          watcher.close();
        }
    ...
    DocPad.prototype.watch = function(opts, next) {
      var changeHandler, config, database, docpad, locale, performGenerate, queueRegeneration, ref1, regenerateTimer, restartWatchers;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = this.getConfig();
      locale = this.getLocale();
    ...
    DocPad.prototype.run = function(opts, next) {
      var config, docpad, locale, ref1, rootPath, run, srcPath;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      locale = this.getLocale();
      config = this.getConfig();
    ...
    DocPad.prototype.update = function(opts, next) {
      var config, dependencies, devDependencies, docpad, ref1, tasks;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = this.getConfig();
    ...
    DocPad.prototype.clean = function(opts, next) {
      var config, docpad, locale, ref1, tasks;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = docpad.getConfig();
      locale = this.getLocale();
    ...
    DocPad.prototype.useSkeleton = function(skeletonModel, opts, next) {
      var docpad, locale, ref1, skeletonId, skeletonName;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      locale = this.getLocale();
      if (opts.destinationPath == null) {
    ...
    DocPad.prototype.serveDocument = function(opts, next) {
      var charset, collection, config, content, contentType, ctime, docpad, document, dynamic, encoding, err, etag, mtime, ref1, req, res, stat, templateData;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
    ...
    DocPad.prototype.server = function(opts, next) {
      var config, docpad, express, hostname, http, locale, port, ref1, ref2, ref3, ref4, servers, tasks;
      ref1 = extractOptsAndCallback(opts, next), opts = ref1[0], next = ref1[1];
      docpad = this;
      config = this.config;
      locale = this.getLocale();
      ...
      if (opts.middlewareBodyParser == null) {
        opts.middlewareBodyParser = (ref2 = config.middlewareBodyParser) != null ? ref2 : config.middlewareStandard;
      }
      if (opts.middlewareMethodOverride == null) {
        opts.middlewareMethodOverride = (ref3 = config.middlewareMethodOverride) != null ? ref3 : config.middlewareStandard;
      }
      if (opts.middlewareExpressRouter == null) {
        opts.middlewareExpressRouter = (ref4 = config.middlewareExpressRouter) != null ? ref4 : config.middlewareStandard;
      }
